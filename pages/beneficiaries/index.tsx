...
const BlogPage = () => {
  ...
  const handleSearch = (e: { target: { value: string; }; } ) => {
    ...
    const filteredStory = articles.filter((article: any) => article.name.toLowerCase().includes(input.toLocaleLowerCase()))
...
<main>
  <div>
    <input type="search" placeholder="type search" onChange={(e) => handleSearch(e)} />
