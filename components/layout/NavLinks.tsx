...
const NavLinks = ({ className, donateLink, toggle, open }: Props) => {
  ...
  return (
    <nav
      id="menu"
      className={`${className} ${classes.navLinks}`}
    ...
    >
      ...
      <Link
        href="/aboutUs"
        className={`${router.pathname == "/aboutUs" && classes.active}`}
        onClick={toggle}
        role="link"
      ...
      <Link
        href="/programs"
        className={`${router.pathname.includes("/programs") && classes.active}`}
        onClick={toggle}
        role="link"
        aria-label="programs page link"
      >
        Programs
      </Link>
      <Link
      ...
      <Link
        href="/ContactUs"
        className={`${router.pathname == "/ContactUs" && classes.active}`}
        onClick={toggle}
        role="link"
